...
class Plan_Model( Base_Model ) :
    ...
    plan_content   = relationship( "Plan_Content_Model" , back_populates = "plan" ) # 方案內容 ( 項目 )
    plan_price     = relationship( "Plan_Price_Model" ,   back_populates = "plan" ) # 方案價格
    plan_order     = relationship( "Plan_Order_Model" ,   back_populates = "plan" ) # 方案購買訂單
