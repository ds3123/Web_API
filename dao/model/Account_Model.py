...
class Account_Model( Base_Model ) :
    ...
    # 關聯
    employee      = relationship( "Employee_Model" , back_populates = "shop_account" , cascade = "all,delete-orphan" ) # 所屬店家員工
    customer      = relationship( "Customer_Model" , back_populates = "account"      , cascade = "all,delete-orphan" ) # 所屬店家客人
